...
import (
	msgPo "github.com/star-table/startable-server/app/service/msgsvc/po"
...
func InsertMessage(po msgPo.PpmTakMessage, tx ...sqlbuilder.Tx) error {
	var err error = nil
	if tx != nil && len(tx) > 0 {
...
func InsertMessageBatch(pos []msgPo.PpmTakMessage, tx ...sqlbuilder.Tx) error {
	var err error = nil
...
func UpdateMessage(po msgPo.PpmTakMessage, tx ...sqlbuilder.Tx) error {
	var err error = nil
	if tx != nil && len(tx) > 0 {
...
func SelectMessageById(id int64) (*msgPo.PpmTakMessage, error) {
	po := &msgPo.PpmTakMessage{}
...
func SelectMessageByIdAndOrg(id int64, orgId int64) (*msgPo.PpmTakMessage, error) {
	po := &msgPo.PpmTakMessage{}
...
func SelectMessage(cond db.Cond) (*[]msgPo.PpmTakMessage, error) {
	pos := &[]msgPo.PpmTakMessage{}
...
func SelectOneMessage(cond db.Cond) (*msgPo.PpmTakMessage, error) {
	po := &msgPo.PpmTakMessage{}
...
func SelectMessageByPage(cond db.Cond, pageBo bo.PageBo) (*[]msgPo.PpmTakMessage, uint64, error) {
	pos := &[]msgPo.PpmTakMessage{}
